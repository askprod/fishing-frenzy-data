module IconsHelper
  ...
  def icon_arrow_trend_up(color, size: 6, extra_classes: [])
    render_svg(
      "M416 224C398.3 224 384 209.7 384 192C384 174.3 398.3 160 416 160L576 160C593.7 160 608 174.3 608 192L608 352C608 369.7 593.7 384 576 384C558.3 384 544 369.7 544 352L544 269.3L374.6 438.7C362.1 451.2 341.8 451.2 329.3 438.7L224 333.3L86.6 470.6C74.1 483.1 53.8 483.1 41.3 470.6C28.8 458.1 28.8 437.8 41.3 425.3L201.3 265.3C213.8 252.8 234.1 252.8 246.6 265.3L352 370.7L498.7 224L416 224z",
      color,
      size: size,
      viewBox: "0 0 640 640",
      extra_classes: extra_classes
  ...
  def icon_backpack(color, size: 6, extra_classes: [])
    render_svg(
      "M280 112L360 112C364.4 112 368 115.6 368 120L368 160L272 160L272 120C272 115.6 275.6 112 280 112zM224 120L224 160C153.3 160 96 217.3 96 288L96 512C96 547.3 124.7 576 160 576L176 576L176 440C176 400.2 208.2 368 248 368L392 368C431.8 368 464 400.2 464 440L464 576L480 576C515.3 576 544 547.3 544 512L544 288C544 217.3 486.7 160 416 160L416 120C416 89.1 390.9 64 360 64L280 64C249.1 64 224 89.1 224 120zM416 576L416 440C416 426.7 405.3 416 392 416L248 416C234.7 416 224 426.7 224 440L224 576L416 576zM248 240L392 240C405.3 240 416 250.7 416 264C416 277.3 405.3 288 392 288L248 288C234.7 288 224 277.3 224 264C224 250.7 234.7 240 248 240z",
      color,
      size: size,
      viewBox: "0 0 640 640",
      extra_classes: extra_classes
